...
import { Building2, TrendingUp, Wallet, DollarSign, Coins, ArrowUpCircle, ArrowDownCircle, ArrowRightLeft } from 'lucide-react';
...
function ManagementTab({ capitalBalance, distributionBalance, profitsBalance, user, companyBankAccounts }: any) {
  ...
  const recordDistributionMutation = trpc.treasury.recordDistribution.useMutation({
    onSuccess: () => {
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
        ...
        <Dialog open={capitalDialogOpen} onOpenChange={setCapitalDialogOpen}>
          <DialogTrigger asChild>
            <Button className="w-full h-32 text-lg" variant="default">
            ...
            <div className="space-y-4">
              ...
              <div className="p-4 border rounded-lg space-y-3">
                ...
                <Input
                  ...
                  placeholder="0.00"
                  disabled={!distributionForm.bank_lyd_account}
                />
              </div>
              ...
              <div className="p-4 border rounded-lg space-y-3">
                ...
                <Input
                  ...
                  placeholder="0.00"
                  disabled={!distributionForm.bank_usd_account}
                />
              </div>
